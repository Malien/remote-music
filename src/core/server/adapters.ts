...
export interface ClientServerAdapter {
    ...
    on(event: "serviceToken",               listener: (service: string, token: string | null) => void): this;
    ...
    off(event: "serviceToken",              listener: (service: string, token: string | null) => void): this;
    ...
    addListener(event: "serviceToken",      listener: (service: string, token: string | null) => void): this;
    ...
    removeListener(event: "serviceToken",   listener: (service: string, token: string | null) => void): this;
    ...
    emit(event: "serviceToken",             service: string, token: string | null): boolean;
